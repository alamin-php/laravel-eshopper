            ...
            <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
              @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                      ...
                      <div class="form-group">
                        <label for="long_description"> {{ __('Long discription') }}</label>
                          ...
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{!! $product->long_description !!}</textarea>
                  ...
                  <div class="col-md-6">
                  <img width="200" class="img-thumbnail" id="image" src="{{ asset($product->image) }}" alt="User profile picture">
                  </div>
                  </div>
                </div>
